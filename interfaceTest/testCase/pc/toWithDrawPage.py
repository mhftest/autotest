...
class ToWithDrawPageTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        c=r.cookies
        #http://192.168.1.249:8984/hk-financial-services/indexController/fasterLogin.do
        url=url1+'/hk-financial-services/withdrawCashController/toWithDrawPage.do'
...
#http://192.168.1.249:8984/hk-financial-services/withdrawCashController/toWithDrawPage.do