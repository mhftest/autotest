...
biddinfolist = get_excel_value("bidInfoList.xls", "toInvest")
...
class toInvestTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        t=r.text
        c=r.cookies
        #http://192.168.1.249:8984/hk-financial-services/bidInfoController/toInvest.do
        url=url1+'/hk-financial-services/bidInfoController/toInvest.do'
