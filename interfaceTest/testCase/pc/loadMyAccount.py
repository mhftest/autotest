...
class loadMyAccountTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        t=r.text
        c=r.cookies
        #http://192.168.1.249:8984/hk-financial-services/userController/loadMyAccount.do
        url=url1+'/hk-financial-services/userController/loadMyAccount.do'
        ...
        print(resStatus[0])
        self.assertEqual(int(resStatus[0]), 0)
