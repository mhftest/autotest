...
class ToRechargeTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        c=r.cookies
        #http://192.168.1.249:8984/hk-financial-services/indexController/fasterLogin.do
        url=url1+'/hk-financial-services/finPaymentRechargeController/toRecharge.do'
        r = requests.post(url,cookies=c)  # 发送请求
        print ('status:', r.status_code)
        t=r.text
        print(t)
...
#http://192.168.1.249:8984/hk-financial-services/finPaymentRechargeController/toRecharge.do